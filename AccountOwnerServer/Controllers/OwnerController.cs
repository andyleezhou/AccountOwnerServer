    ...
    public class OwnerController : Controller
    {
        ...
        public async Task<IActionResult> DeleteOwner(Guid id)
        {
            try
            {
                ...
                {
                    _logger.LogError($"Cannot delete owner with id {id}. Please delete realted accounts first");
                    return BadRequest("Cannot delete owner. Please delete realted accounts first");
                }
